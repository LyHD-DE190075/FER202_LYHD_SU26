      ...
      <Card className="shadow-sm">
        ...
        <Card.Body>
          ...
          <ListGroup variant="flush">
            <ListGroup.Item>
              Car Type: <Badge bg="primary">{carTypeName}</Badge>
            </ListGroup.Item>
            <ListGroup.Item>Brand: {car.brand}</ListGroup.Item>
            <ListGroup.Item>Transmission: {car.transmission}</ListGroup.Item>
            <ListGroup.Item>Price Weekday: {formatVND(car.priceWeekday)}</ListGroup.Item>
            <ListGroup.Item>Price Weekend: {formatVND(car.priceWeekend)}</ListGroup.Item>
            <ListGroup.Item>Last Serviced: {formatDateDisplay(car.lastServiced)}</ListGroup.Item>
          </ListGroup>
        </Card.Body>
      </Card>
    </div>
