*Bài Tập CRUD – Axios + json-server + React*
...
| --- | --- | --- | --- |
| admin | 123456 | Admin | Xem, Thêm, Sửa, Xóa, Đổi trạng thái |
| manager | 123456 | Manager | Xem, Thêm, Sửa, Đổi trạng thái |
| user1 | 123456 | User | Chỉ xem |
...
| --- | --- | --- |
| GET | http://localhost:3001/users | Lấy tất cả users |
| GET | http://localhost:3001/users/1 | Lấy user id=1 |
| GET | http://localhost:3001/users?role=Admin | Lọc theo role |
| POST | http://localhost:3001/users | Thêm user mới vào db.json |
| PUT | http://localhost:3001/users/1 | Cập nhật toàn bộ user id=1 |
| PATCH | http://localhost:3001/users/1 | Cập nhật 1 phần user id=1 |
| DELETE | http://localhost:3001/users/1 | Xóa user id=1 khỏi db.json |
